...
// ローディングストアの初期状態を生成
const createInitialLoadings = (): LoadingState => ({
...
/**
 * ローディングストアを作成するファクトリー関数
 * 共通のローディング管理ロジックを提供
 */
export const createLoadingStore = (): StateCreator<LoadingStore> => {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  return (set, get, _api) => ({
    loadings: createInitialLoadings(),
